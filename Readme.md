...
## Agent-based backtest
This is personal backtest framework based on optiver ready trader go. I change a little code according to my custom and research env.

### Quickly start
using below command to create env and install package:

```shell
conda env remove -n AgentBasedBacktest
conda create -n AgentBasedBacktest python=3.11
...
### File Structure
files following the below structure:
+ data: orders data for backtesting
+ ready_trader_go: mock exchange
+ pyready_trader_go_20230310.zip: origin zip file for the sys


##### below is the origin readme and some quick instruction
-----------------------------------------------------------
